...
xhr.open('POST', 'http://localhost:8080/api/guardarpersonaje');
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'http://loaclhost:8080/api/modificarpersonaje');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'http://localhost:8080/api/Eliminarpersonaje');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
